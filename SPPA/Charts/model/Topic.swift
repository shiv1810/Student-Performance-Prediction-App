...
struct Topic: Identifiable, Equatable {
    ...
    static var example = Topic(id: UUID(),
                               title: "Algorithms",
    ...
    static var examples = [
        Topic(id: UUID(), title: "Algorithms", description: "Introduction to basic algorithms", category: .computerScience, difficulty: 3),
        Topic(id: UUID(), title: "Data Structures", description: "Fundamentals of data structures", category: .computerScience, difficulty: 2),
        Topic(id: UUID(), title: "Programming Languages", description: "Overview of programming languages", category: .computerScience, difficulty: 2),
        Topic(id: UUID(), title: "Databases", description: "Introduction to database systems", category: .computerScience, difficulty: 3),
        Topic(id: UUID(), title: "Software Engineering", description: "Principles of software engineering", category: .computerScience, difficulty: 4),
        Topic(id: UUID(), title: "Artificial Intelligence", description: "Basic concepts of artificial intelligence", category: .computerScience, difficulty: 4)
    ]
}

enum TopicCategory: String, Identifiable, CaseIterable {
